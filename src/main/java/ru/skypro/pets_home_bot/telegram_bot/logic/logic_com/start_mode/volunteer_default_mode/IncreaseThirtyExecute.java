...
import static ru.skypro.pets_home_bot.telegram_bot.logic.constants.Link.INCREASE_THIRTY_NUM_NUM;
@Component
public class IncreaseThirtyExecute implements ExecuteMessage {
    private final ParseUtil parseUtil;
    private final OwnerService ownerService;
    private final int additionalPeriod = 30;

    public IncreaseThirtyExecute(ParseUtil parseUtil, OwnerService ownerService) {
    ...
    public String getLink() {
        return INCREASE_THIRTY_NUM_NUM;
    }
