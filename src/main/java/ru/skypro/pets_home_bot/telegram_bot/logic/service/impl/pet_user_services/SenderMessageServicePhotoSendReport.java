...
@Service
public class SenderMessageServicePhotoSendReport extends SenderMessageServiceAbstract {
    public SenderMessageServicePhotoSendReport(ParseUtil parseUtil, List<ExecuteMessage> executeMessages) {
        super(parseUtil, executeMessages, MessageMode.PHOTO_REPORT);
    }
